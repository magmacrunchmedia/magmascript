...
### Changed
- Repository moved to the `magmacrunch-media` GitHub organization. All URLs
  updated; old links redirect automatically.

### Added
- MC1 domain: `start_service` and `stop_service` methods for managing Windows
  services over SSH.
...
[3.2.2]: https://github.com/magmacrunch-media/magmascript/compare/v3.2.1...v3.2.2
[3.2.1]: https://github.com/magmacrunch-media/magmascript/compare/v3.2.0...v3.2.1
